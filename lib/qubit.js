...
class QuantumComputing {
  ...
  getResult() {
    ...
    const helper = (offset, bitString, probability)=> {
      ...
      helper(offset+1, '0' + bitString, math.multiply(probability, math.pow(this.qubits[this.measures[offset]].a, 2)))
      helper(offset+1, '1' + bitString, math.multiply(probability, math.pow(this.qubits[this.measures[offset]].b, 2)))
    }
